...
function _getAnnotationByID() {
  ...
  /*#__PURE__*/
  _regenerator.default.mark(function _callee56(docid, page, user) {
    var client, result;
    ...
    return _regenerator.default.wrap(function _callee57$(_context57) {
      while (1) {
        switch (_context57.prev = _context57.next) {
          ...
          case 2:
            global.searchIndex = _context57.sent;
            _context57.next = 5;
            return UMLSData();
    ...
    return _regenerator.default.wrap(function _callee27$(_context27) {
      while (1) {
        switch (_context27.prev = _context27.next) {
          ...
          case 18:
            allCollectionData = JSON.parse(req.body.collectionData); // debugger
            ...
            _context27.next = 22;
            return createCollection(allCollectionData.collection_id, allCollectionData.title, allCollectionData.description, allCollectionData.owner_username);
    ...
    return _regenerator.default.wrap(function _callee60$(_context60) {
      while (1) {
        switch (_context60.prev = _context60.next) {
          ...
          case 10:
            cuirec = _context60.sent;
            _context60.t0 = _regenerator.default.keys(available_documents);

          case 12:
            if ((_context60.t1 = _context60.t0()).done) {
              _context60.next = 49;
              break;
            }

            docid = _context60.t1.value;
            _context60.t2 = _regenerator.default.keys(available_documents[docid].pages);

          case 15:
            if ((_context60.t3 = _context60.t2()).done) {
              _context60.next = 47;
              break;
            }

            page = _context60.t3.value;
          ...
          case 21:
            ...
            return _context60.abrupt("continue", 15);
          ...
          case 30:
            _context60.prev = 30;
            _context60.t4 = _context60["catch"](25);
        ...
        switch (_context42.prev = _context42.next) {
          case 0:
            ...
            function () {
              ...
              /*#__PURE__*/
              _regenerator.default.mark(function _callee41(phrase) {
                var result;
      ...
      while (1) {
        switch (_context44.prev = _context44.next) {
          ...
          case 5:
            ...
            _context44.t2 = {
              results: _context44.t1
            };

            _context44.t0.send.call(_context44.t0, _context44.t2);
      ...
      while (1) {
        switch (_context50.prev = _context50.next) {
          ...
          case 3:
            ...
            counter = 0;
            _context50.t0 = _regenerator.default.keys(available_documents);
          ...
          case 10:
            ...
            doc = _context50.t1.value;
            _context50.t2 = _regenerator.default.keys(available_documents[doc].pages);

          case 13:
            if ((_context50.t3 = _context50.t2()).done) {
              _context50.next = 36;
              break;
            }

            p = _context50.t3.value;
            ...
            return _context50.abrupt("continue", 13);
          ...
          case 29:
            _context50.prev = 29;
            _context50.t4 = _context50["catch"](23);
        ...
        switch (_context52.prev = _context52.next) {
          case 0:
            ...
            function () {
              ...
              /*#__PURE__*/
              _regenerator.default.mark(function _callee51(docid, page, user, annotation, corrupted, tableType, corrupted_text) {
                var client, done;
